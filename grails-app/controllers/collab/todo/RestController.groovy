...
class RestController {
	...
	def create = {
		...
		def input = ""
		request.inputStream.eachLine { input += it }
	...
	def beforeInterceptor = {
		...
		domainClassName = StringUtils.capitalize(params.domain)
		domainClassName = "collab.todo." + domainClassName
		domainClass = grailsApplication.getArtefact("Domain", domainClassName)  // domainClassName MUST be fully qualified!
	}
