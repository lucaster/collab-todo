                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class='prop'><td valign='top' class='name'><label for='user'>User:</label></td><td valign='top' class='value ${hasErrors(bean:category,field:'user','errors')}'><g:select optionKey="id" from="${collab.todo.User.list()}" name='user.id' value="${category?.user?.id}" ></g:select></td></tr>
                        </tbody>
                    </table>
                </div>
                <div class="buttons">
